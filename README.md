A real estate project website which is build up of ReactJS as frontend library , python Django as backend with the integration of PostGreSQL as database.
